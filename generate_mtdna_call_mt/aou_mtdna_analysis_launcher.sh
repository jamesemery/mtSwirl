...
#### PARAMETERS
export numTest=1 # number of samples per iteration
...
#### DOWNLOAD DATA
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/v2.5_MongoSwirl_Single/scatterWrapper_MitoPipeline_v2_5.wdl -o scatterWrapper_MitoPipeline_v2_5.wdl
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/check_variant_bounds.R -o check_variant_bounds.R
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/compatibilify_fa_intervals_consensus.R -o compatibilify_fa_intervals_consensus.R
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/jsontools.py -o jsontools.py
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/merge_per_batch.py -o merge_per_batch.py
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/check_overlapping_homoplasmies.R -o check_overlapping_homoplasmies.R
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/scripts/fix_liftover.py -o fix_liftover.py
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/files/NUMTv3_all385.hg38.interval_list -o NUMTv3_all385.hg38.interval_list
curl https://raw.githubusercontent.com/MoothaLab/mtSwirl/master/WDL/files/prepopulated_inputs.json -o input_allofus.needsfix.json
sed 's/MitochondriaPipeline/MitochondriaPipelineWrapper/' input_allofus.needsfix.json > input_allofus.json
